...
knee = DephyLegacyActuator(tag="Knee", gear_ratio=9, offline=False)
with knee:
    knee.set_motor_zero_position(knee.motor_position)
    ...
    for t in SoftRealtimeLoop(1/100, True):
        ...
        controller.run()
        print(imu.acc_z, controller.outputs.knee_angle_rad)
